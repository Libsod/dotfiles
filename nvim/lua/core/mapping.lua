...
local core_map = {
	["n|<C-Tab>"] = map_cr("normal za"):with_noremap():with_silent():with_desc("edit: Toggle code fold"),
	["n|<C-s>"] = map_cu("write"):with_noremap():with_silent():with_desc("edit: Save file"),
	["n|Y"] = map_cmd("y$"):with_desc("edit: Yank text to EOL"),
	["n|D"] = map_cmd("d$"):with_desc("edit: Delete text to EOL"),
	["n|<C-c>"] = map_cmd("<cmd> %y+ <CR>"):with_noremap():with_desc("edit: Copy whole file"),
	...
	["n|<A-]>"] = map_cr("vertical resize +5"):with_silent():with_desc("window: Resize +5 vertically"),
	["n|<A-;>"] = map_cr("resize -3"):with_silent():with_desc("window: Resize -3 horizontally"),
	["n|<A-'>"] = map_cr("resize +3"):with_silent():with_desc("window: Resize +2 horizontally"),
	...
	["n|<leader>ba"] = map_cmd("<cmd>bufdo bd!<CR>"):with_noremap():with_silent():with_desc("edit: Close all buffers"),
	["n|<leader>bd"] = map_cmd("<cmd>bd!<CR>"):with_noremap():with_silent():with_desc("edit: Close current buffer"),

	-- Insert mode
	["i|<C-u>"] = map_cmd("<C-G>u<C-U>"):with_noremap():with_desc("edit: Delete previous block"),
	["i|<C-h>"] = map_cmd("<Left>"):with_noremap():with_silent():with_desc("edit: Move cursor to left"),
	["i|<C-j>"] = map_cmd("<Down>"):with_noremap():with_silent():with_desc("edit: Move cursor up"),
	["i|<C-k>"] = map_cmd("<Up>"):with_noremap():with_silent():with_desc("edit: Move cursor down"),
	["i|<C-l>"] = map_cmd("<Right>"):with_noremap():with_silent():with_desc("edit: Move cursor to right"),
	["i|<C-e>"] = map_cmd("<ESC>^i"):with_noremap():with_silent():with_desc("edit: Move cursor to line start"),
	["i|<C-b>"] = map_cmd("<End>"):with_noremap():with_silent():with_desc("edit: Move cursor to end of line"),
	["i|<C-s>"] = map_cmd("<Esc>:w<CR>"):with_silent():with_desc("edit: Save file"),
	["i|<C-q>"] = map_cmd("<Esc>:wq<CR>"):with_silent():with_desc("edit: Save file and quit"),
	-- Command mode
